...
>(({ className, ...props }, ref) => (
  <div
    ...
    role="tablist"
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-[#0f2847] border border-[#1a3a5c] p-1 text-[#94a3b8]",
      className
    )}
    {...props}
  />
      ...
      <button
        ...
        className={cn(
          ...
          isActive
            ...
            : "text-[#94a3b8] hover:text-[#fafafa] hover:bg-[#1a3a5c]/50",
          className
        )}
        {...props}
      />
