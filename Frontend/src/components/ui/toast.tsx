...
const toastVariants = cva(
  "pointer-events-auto relative flex w-full items-center justify-between gap-3 overflow-hidden rounded-lg border p-4 shadow-lg transition-all",
  {
    variants: {
      variant: {
        default: "border-[#1a3a5c] bg-[#0f2847] text-[#fafafa]",
        success: "border-green-600/30 bg-green-950/80 text-green-200",
        error: "border-red-600/30 bg-red-950/80 text-red-200",
        info: "border-blue-600/30 bg-blue-950/80 text-blue-200",
      },
    },
    defaultVariants: {
      variant: "default",
